...
export const sheetRoot =
  "fixed inset-x-0 bottom-0 z-20 flex flex-col gap-3 overflow-clip rounded-t-3xl border-t border-solid border-default-300 bg-surface-raised pb-4 pt-3 shadow-nav";
