...
export const sheetGripBar =
  "dot-grid absolute top-0 left-0 z-30 w-full flex shrink-0 touch-none flex-col items-center gap-1.5 px-4 pb-12 pt-3 backdrop-blur-md [-webkit-mask-image:linear-gradient(to_bottom,black,black_45%,transparent)] [mask-image:linear-gradient(to_bottom,black,black_45%,transparent)]";
...
export const sheetTitleBlock =
  "flex flex-col w-full items-start gap-1 px-4 pt-3";
