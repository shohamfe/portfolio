...
export const indicatorColumn =
  "flex w-10 shrink-0 flex-col items-center gap-1 self-stretch";
...
export const entryTitle =
  "font-body text-[20px] font-semibold text-text-strong";
...
export const entryBullets =
  "list-disc pl-5 font-ui text-small text-text-strong marker:text-default-400";

export const sectionHeader = "flex flex-col items-start gap-1 pb-4 pl-14";

export const sectionHeading =
  "font-display text-[24px] font-extrabold text-black";
